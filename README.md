...
See [benchmark_instances/modified_solomon_36/README.md](benchmark_instances/modified_solomon_36/README.md) for details.
...
See [benchmark_instances/xiamen_zhangzhou_45/README.md](benchmark_instances/xiamen_zhangzhou_45/README.md) for details.

## Dataset Description

A high-level description of both benchmark groups is available in:

[benchmark_instances/README.md](benchmark_instances/README.md)
